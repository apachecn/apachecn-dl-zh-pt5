<title>B15385_06_Final_RK_ePub</title>
...
我们在训练预测模型的同时学习这些嵌入是什么意思？单词嵌入不是通过使用诸如`word2vec`之类的算法来学习的吗，该算法试图根据上下文术语来预测中心单词(还记得我们在*第 4 章，文本嵌入的深度学习*中讨论的 CBOW 架构吗)？嗯，是也不是:
