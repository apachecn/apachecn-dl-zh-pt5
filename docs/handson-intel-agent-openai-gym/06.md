...
![](img/00145.jpeg)<title>Customizing the Atari Gym environment</title> 
...
![](img/00148.jpeg)<title>Putting together a comprehensive deep Q-learner</title> 
...
我们开始这一章的宏伟目标是开发能够在 Atari 游戏中取得巨大分数的智能学习代理。我们通过实施几项技术来改进我们在前一章开发的 Q-learner，在这方面取得了渐进的进展。我们首先开始学习如何使用神经网络来逼近 Q 动作值函数，并通过实际实现一个浅层神经网络来解决著名的 Cart 极点问题，从而使我们的学习具体化。然后，我们实现了经验记忆和经验重放，使代理能够从(小)随机抽样的批量经验中学习，通过打破代理交互之间的相关性，提高代理先前经验的批量重放的样本效率，从而帮助提高性能。然后，我们重新研究了ε-贪婪行为选择策略，并实现了一个衰减时间表，以减少基于时间表的探索，让代理更加依赖于它的学习。
