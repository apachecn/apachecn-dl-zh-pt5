...
*   首先，输入句子的单词被映射到实数向量。这一步称为单词的矢量表示或词嵌入(更多细节参见[第三章](part0040_split_000.html#164MG1-ccdadb29edc54339afcb9bdf9350ba6b "Chapter 3. Encoding Word into Vector")，*将单词编码成矢量*)。
