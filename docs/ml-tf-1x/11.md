...
本节将向大家介绍几个在 TensorFlow 和 Github 上开源实现的问题。我们建议你看看这些项目，学习如何提高你的TensorFlow技能。
...
在这一章中，我们提供了许多有趣的挑战和问题，你可以尝试解决并从中学习，以提高你的TensorFlow技能。在本章的最后，我们还指导您将 Caffe 模型转换为 TensorFlow，并向您介绍了高级 TensorFlow 库 TensorFlow-Slim。