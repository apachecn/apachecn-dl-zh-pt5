...
很明显，我们已经创造了一个聊天机器人，能够进行简单的来回对话。然而，在我们的聊天机器人能够通过图灵测试，并能够让我们相信我们实际上在与人类交谈之前，我们还有很长的路要走。然而，考虑到我们用来训练模型的数据相对较少，在我们的序列到序列模型中使用注意力的已经显示出相当好的结果，证明了这些架构是多么的多才多艺。
