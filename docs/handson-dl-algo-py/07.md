<title>Improvements to the RNN</title>  
...
<title>Understanding the LSTM cell</title>  
...
因此，为了在时间步![](img/99f9244a-a159-4c7a-8a0e-2bb3bded1610.png)生成目标单词，解码器在时间步![](img/df8ae413-f3a8-4d68-b6c6-6495a04084f3.png)使用上下文向量![](img/a3f119f5-ae5c-485d-af13-98f8387e724c.png)。利用注意机制，我们从编码器获得所有隐藏状态的总和，并将其用作上下文向量，而不是将最后的隐藏状态作为上下文向量并将其用于解码器。
